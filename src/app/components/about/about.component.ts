...
export class AboutComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.seoService.updateSeoTags({
      title: 'About Us',
      description: 'Learn about PowerElectric - your trusted partner for professional electrical solutions. With years of expertise, we provide quality service to residential, commercial, and industrial clients.',
